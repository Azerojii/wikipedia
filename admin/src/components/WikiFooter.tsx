        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <a
                  href="https://www.facebook.com/GrandeMosqueeDeParis"
                  target="_blank"
              ...
              <li>
                <a
                  href="https://www.instagram.com/grandemosqueedeparis"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 text-primary hover:underline"
                >
              ...
              <li>
                <a
                  href="https://www.youtube.com/@GrandeMosqueedeParis"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 text-primary hover:underline"
                >
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <a
                  href="https://www.grande-mosquee-de-paris.org"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-primary hover:underline"
                >
                  Site officiel — Grande Mosquée de Paris
                </a>
              </li>
            </ul>
          </div>
